...
pub mod work_schedule_day {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "work_schedule_days")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod attendance_correction {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "attendance_corrections")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod leave_approval {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "leave_approvals")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod permission_type {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "permission_types")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod overtime_approval {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "overtime_approvals")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod salary_component {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "salary_components")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod employee_salary_component {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "employee_salary_components")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod payroll_detail {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "payroll_details")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod payroll_deduction {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "payroll_deductions")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod candidate_document {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "candidate_documents")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod recruitment_stage {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "recruitment_stages")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod candidate_assessment {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "candidate_assessments")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod onboarding_task {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "onboarding_tasks")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod offboarding {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "offboarding")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod exit_interview {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "exit_interviews")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod clearance_item {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "clearance_items")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod performance_period {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "performance_periods")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod performance_detail {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "performance_details")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod training_participant {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "training_participants")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod asset_assignment {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "asset_assignments")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod asset_maintenance {
    ...
    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "asset_maintenance")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod business_trip_expense {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "business_trip_expenses")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
...
pub mod reimbursement_category {
    use sea_orm::entity::prelude::*;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "reimbursement_categories")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i32,
    }
